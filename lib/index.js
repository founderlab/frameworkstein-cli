...
_commander2['default'].command('create_model <name>').alias('add_model').alias('model').alias('m').description('Create a new model in the current app').action(function (name) {
