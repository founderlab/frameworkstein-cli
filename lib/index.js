...
_commander2['default'].command('create_model <name>').alias('add_model').description('Create a new model in the current app').action(function (name) {
  ...
  require('./commands/create_model')(options, function (err) {
